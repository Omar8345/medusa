import { CalculatedShippingOptionPrice, PricingTypes, StockLocationAddressDTO } from ".."
...
/**
 * The retrieved shipping options.
 */
export type ListShippingOptionsForCartWorkflowOutput = {
  /**
   * The shipping option's ID.
   */
  id: string
  ...
  /**
   * Custom additional data related to the shipping option, useful for the fulfillment provider
   * to process the shipping option.
   * 
   * Learn more in [this documentation](https://docs.medusajs.com/resources/commerce-modules/fulfillment/shipping-option#data-property).
   */
  data: Record<string, unknown>
  ...
  /**
   * All of the shipping option's prices.
   */
